...
\begin{align}
d(\textbf{p},\textbf{q}) = d(\textbf{q},\textbf{p}) & = \sqrt{ \left(q_1 - p_1 \right)^2 + \left(q_2 - p_1\right)^2 + \dots + \left(q_n - p_n\right)^2} \\
 & =  \sqrt{\sum_{i=1}^{\infty} \left(q_i - p_i\right)^2}.
\end{align}
...
\[
\left\Vert{p}\right\Vert = \sqrt{(p_1)^2 + (p_2)^2 + \dots + (p_n)^2} = \sqrt{{p} \cdot {p}},
\]
